...
`Employee Performance Dashboard.pbix` is an interactive companion dashboard built on the same dataset, including:
...
> Open `Employee Performance Dashboard.pbix` in [Power BI Desktop](https://powerbi.microsoft.com/desktop/) (free) to explore interactively.
...
- **BI:** Power BI Desktop
- **Data source:** Onyx Data DataDNA Challenge – Employee Performance and Productivity Dataset (Oct 2024) — credit to Onyx Data for the dataset
---
...
jupyter notebook "Project_2_HR_Analytics.ipynb"
```
 
The notebook reads the source Excel file directly from this repo (same folder).
 
---
 
## 📬 Contact
 
**Shaline S** — [LinkedIn](https://www.linkedin.com/in/shaline06/) · [GitHub](https://github.com/shaline0616) · [shaline0616@gmail.com](mailto:shaline0616@gmail.com)
